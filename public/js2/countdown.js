!(function (n, t) {
	"object" == typeof exports && "object" == typeof module
		...
		? (exports["grapesjs-component-countdown"] = t())
		: (n["grapesjs-component-countdown"] = t());
					...
					defaults: e(
						{
							...
							script: function (n) {
								...
								p.forEach(function (n) {
									...
									p.indexOf(o) < 0 && p.push(o),
									(window.__gjsCountdownIntervals = p.filter(function (n) {
								...
								var y = function (n, t, e, o) {
									...
									f = function () {
										...
										y(s, l, i, r),
											t < 0 &&
												(clearInterval(o.__gjsCountdownInterval),
												(d.innerHTML = e),
												(c.style.display = "none"),
												(d.style.display = ""));
									};
								a
									? ((o.__gjsCountdownInterval = setInterval(f, 1e3)), (d.style.display = "none"), (c.style.display = ""), f())
									: y(0, 0, 0, 0);
							},
							"script-props": ["startfrom", "endText"],
							traits: [
								{ label: "Start", name: "startfrom", changeProp: !0, type: o.dateInputType },
								{ label: "End text", name: "endText", changeProp: !0 },
							],
							components: '\n          <span data-js="countdown" class="'
								...
								.concat(i, '-digit"></div>\n              <div class="')
								.concat(i, '-label">')
								.concat(o.labelDays, '</div>\n            </div>\n            <div class="')
								.concat(i, '-block">\n              <div data-js="countdown-hour" class="')
								.concat(i, '-digit"></div>\n              <div class="')
								.concat(i, '-label">')
								.concat(o.labelHours, '</div>\n            </div>\n            <div class="')
								.concat(i, '-block">\n              <div data-js="countdown-minute" class="')
								.concat(i, '-digit"></div>\n              <div class="')
								.concat(i, '-label">')
								.concat(o.labelMinutes, '</div>\n            </div>\n            <div class="')
