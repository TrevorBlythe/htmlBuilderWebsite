			...
			t.exports = function (t, e) {
				...
				if (Object.getOwnPropertySymbols) {
					...
					for (o = 0; o < c.length; o++)
						(n = c[o]), e.indexOf(n) >= 0 || (Object.prototype.propertyIsEnumerable.call(t, n) && (a[n] = t[n]));
				}
				return a;
			};
		},
		...
		function (t, e, n) {
			...
			var b = function (t, e) {
				var n = e.defaultModel,
					r = e.typeTabs,
					a = e.selectorTab,
					i = (e.editor, c()(e, ["defaultModel", "typeTabs", "selectorTab", "editor"])),
					b = [
						{
							full: 1,
							type: "button",
				...
				t.addType(i.typeTab, {
					model: {
						defaults: s(
							{
								name: "Tab",
								draggable: '[data-gjs-type="'.concat(i.typeTabContainer, '"]'),
								attributes: { role: "tab" },
								...
								if (!t) {
									var e,
										n = (t = this.getTabsType()
											.getContentsType()
											.append({ type: i.typeTabContent, components: i.templateTabContent(this) })[0]).getId(),
										r = this.getId();
									t.addAttributes({ id: n, "aria-labelledby": r, hidden: !0 }),
										this.addAttributes(((e = {}), o()(e, a, n), o()(e, "id", r), e)),
										(this.tabContent = t);
								}
								this.tabContent = t;
							}
			...
			var u = function (t, e) {
				var n = e.typeTab,
					...
					i = e.style,
					s = c()(e, ["typeTab", "typeTabContent", "typeTabContents", "typeTabContainer", "style"]),
					b = s.typeTabs,
						...
						defaults: l(
							{
								...
								script: function (t) {
									...
									(v =
										v ||
										((n = (u.hash || "").replace("#", "")) && O(r, ((e = a), "".concat(b, "[").concat(e, "=").concat(n, "]")))) ||
										O(r, b)) && h(v),
								...
								components: [{ type: a, components: p }, { type: o }, i && "<style>".concat(i(s), "</style>")],
							},
							s.tabsProps
						),
						init: function () {
			...
			var j = function (t, e) {
				t.addType(e.typeTabContents, {
					model: {
						defaults: g(
							{ name: "Tab Contents", draggable: !1, droppable: !1, copyable: !1, removable: !1, classes: e.classTabContents },
							e.tabContentsProps
						),
					},
				});
				...
				t.addType(e.typeTabContainer, {
					model: {
						defaults: v(
							{
								name: "Tab Container",
								draggable: '[data-gjs-type="'.concat(e.typeTabs, '"]'),
								droppable: '[data-gjs-type="'.concat(e.typeTab, '"]'),
								copyable: !1,
								removable: !1,
								highlightable: !1,
			...
			var w = function (t) {
				var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
					n = t.DomComponents,
					r = P(P({}, e), {}, { defaultModel: n.getType("default").model, editor: t });
