...
!(function (e, n) {
	...
	(() => {
			...
			l.add(
				...
				(function (e, n) {
					...
					return (
						...
						s.set(c({ codeName: "htmlmixed", theme: "hopscotch", readOnly: 0 }, n.importViewerOptions)),
						{
							run: function (e) {
								if (!d) {
									...
									if (i) {
										...
										(p.className = "".concat(o, "import-label")), (p.innerHTML = i), a.appendChild(p);
									}
									a.appendChild(c), a.appendChild(u), s.init(c), (d = s.editor);
								}
		...
		const u = function (e, n) {
			...
			!(function (e, n) {
				var t = function (t, o) {
					n.blocks.indexOf(t) >= 0 && e.Blocks.add(t, s(s({ select: !0, category: "Basic" }, o), n.block(t)));
				};
				t("link-block", {
					label: "Link Block",
					media:
					...
					e.on("load", function () {
						...
						n.showStylesOnChange &&
							e.on("component:selected", function () {
								...
								(t && t.get("active")) || !e.getSelected() || null == n || n.set("active", !0);
							});
				})(e, c);
		};
		return n;
