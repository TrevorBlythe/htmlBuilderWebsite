			...
			void 0 === a && (a = {}),
				(function (n, a) {
					var t = n.BlockManager,
						...
						b = "\n  .".concat(c, "cell70 {\n    width: 70%;\n  }"),
						g = 1,
						h = { tl: 0, tc: 0, tr: 0, cl: 0, cr: 0, bl: 0, br: 0, minDim: g },
						f = e(e({}, h), { cr: 1, bc: 0, currentUnit: 1, minDim: g, step: 0.2 });
					i && (f.keyWidth = "flex-basis");
					var y = { class: s, "data-gjs-droppable": ".".concat(v), "data-gjs-resizable": h, "data-gjs-name": "Row" },
						C = { class: v, "data-gjs-draggable": ".".concat(s), "data-gjs-resizable": f, "data-gjs-name": "Cell" };
							...
							t.add(
								...
								e(e({}, M), {
									...
									content: "<div "
										.concat(L, ">\n        <div ")
										.concat(H, " style='")
										.concat(i ? "flex-basis" : "width", ": 30%;'></div>\n        <div ")
										.concat(H, " style='")
										.concat(i ? "flex-basis" : "width", ": 70%;'></div>\n      </div>\n      ")
										.concat(
											r
												? "<style>\n          "
														.concat(m, "\n          ")
						...
						w("link") &&
							t.add(
								...
								e(e({}, M), {
									...
									content: { type: "link", content: "Link", style: { color: "#d983a6" } },
								})
							),
						w("image") &&
							t.add(
						...
						w("video") &&
							t.add(
								...
								e(e({}, M), {
									...
									content: { type: "video", src: "img/video2.webm", style: { height: "350px", width: "615px" } },
								})
							),
						w("map") &&
							t.add(
