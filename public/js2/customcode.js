							...
							defaults: r(
								{
									name: "Custom Code",
									editable: !0,
									components: { tagName: "span", components: { type: "textnode", content: "Insert here your custom code" } },
								},
								t.propsCustomCode
							),
							init: function () {
						...
						a(
							{
								...
								showCustomCode: function (t, r) {
									var s = r.title || n,
										a = t.get(o) || "",
										c = this.getContent();
									e.Modal.open({ title: s, content: c }).onceClose(function () {
								...
								getContentActions: function () {
									...
									return (
										...
										(n.className = "".concat(i, "btn-prim ").concat(i, "btn-import__custom-code")),
										(n.onclick = function () {
											return o.handleSave();
										}),
										n
									...
									return (
										this.codeViewer ||
											(this.codeViewer = e.CodeManager.createViewer(
												a({ codeName: "htmlmixed", theme: "hopscotch", readOnly: 0 }, r)
											)),
										this.codeViewer
									);
								},
