...
!(function (t, e) {
	"object" == typeof exports && "object" == typeof module
		...
		? (exports["grapesjs-tui-image-editor"] = e())
		: (t["grapesjs-tui-image-editor"] = e());
})(window, function () {
	return (function (t) {
		var e = {};
		function n(o) {
		...
		function (t, e, n) {
			...
			e.default = function (t) {
				var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
					n = "https://raw.githubusercontent.com/nhnent/tui.image-editor/production/dist/svg/",
					o = a()(
						{},
						{
							config: {},
				...
				var I = t.DomComponents,
					j = I.getType("image").model;
				I.addType("image", {
					model: {
					...
					t.Commands.add(m, {
						run: function (t, e) {
							var n = this,
								...
								i = this.id;
							if (!b) return t.log("TOAST UI Image editor not found", { level: "error", ns: m }), t.stopCommand(i);
							(this.editor = t), (this.target = r.target || t.getSelected());
							var a = this.createContent(),
								c = o.labelImageEditor,
								u = a.children[1];
							t.Modal.open({ title: c, content: a })
								.getModel()
								.once("change:open", function () {
									return t.stopCommand(i);
								}),
								(this.imageEditor = new b(a.children[0], this.getEditorConfig())),
								t.getModel().setEditing(1),
								(u.onclick = function () {
						...
						getEditorConfig: function () {
							var t = a()({}, o.config),
								e = this.target.get("src");
							return (
								t.includeUI || (t.includeUI = {}),
								(t.includeUI = a()({ theme: {} }, t.includeUI, {
									loadImage: { path: e, name: 1 },
									uiSize: { height: u, width: s },
								})),
								l && (t.includeUI.theme["header.display"] = "none"),
								d && (t.includeUI.theme = a()({}, t.includeUI.theme, d)),
								t
							);
						},
						...
						applyChanges: function () {
							var t = this,
								e = this.imageEditor,
								n = this.target,
								o = this.editor.AssetManager;
							p
								? p(e, n)
								: "CROPPER" === e.getDrawingMode()
								? e.crop(e.getCropzoneRect()).then(function () {
										t.uploadImage(e, n, o);
								  })
