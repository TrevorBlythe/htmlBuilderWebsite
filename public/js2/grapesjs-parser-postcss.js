		...
		var e = {
					...
					class f extends u {
						...
						each(e) {
							...
							for (
								...
								((t = this.indexes[r]), (s = e(this.proxyOf.nodes[t], t)), !1 !== s);
						...
						getProxyProcessor() {
							return {
								set: (e, t, s) => (
									e[t] === s || ((e[t] = s), ("name" !== t && "params" !== t && "selector" !== t) || e.markDirty()), !0
								),
								get: (e, t) =>
									"proxyOf" === t
										? e
										...
										? "each" === t || ("string" == typeof t && t.startsWith("walk"))
											? (...s) => e[t](...s.map((e) => ("function" == typeof e ? (t, s) => e(t.toProxy(), s) : e)))
											: "every" === t || "some" === t
					...
					(f.registerParse = (e) => {
						...
						(f.rebuild = (e) => {
							"atrule" === e.type
								...
								: "comment" === e.type && Object.setPrototypeOf(e, h.prototype),
								(e[l] = !0),
								e.nodes &&
									e.nodes.forEach((e) => {
										f.rebuild(e);
							...
							super(e),
								...
								void 0 !== t &&
									...
									("number" == typeof t
										...
										: ((this.line = t.line), (this.column = t.column), (this.endLine = s.line), (this.endColumn = s.column))),
								this.setMessage(),
					...
					function u(e, t) {
						...
						if (s) {
							...
							for (let e of s) {
								...
								s.map && (s.map = { ...s.map, __proto__: i.prototype }), t.push(s);
							}
						}
				...
				995: (e, t, s) => {
					...
					class g {
						...
						error(e, t, s, r = {}) {
							...
							return (
								(i = a
									? new c(
											e,
											void 0 === a.endLine ? a.line : { line: a.line, column: a.column },
											void 0 === a.endLine ? a.column : { line: a.endLine, column: a.endColumn },
											a.source,
											a.file,
											r.plugin
									  )
								...
								(i.input = { line: t, column: s, endLine: n, endColumn: l, source: this.css }),
						...
						origin(e, t, s, r) {
							...
							"number" == typeof s && (i = h.originalPositionFor({ line: s, column: r })),
								(l = a(u.source) ? o(u.source) : new URL(u.source, this.map.consumer().sourceRoot || o(this.map.mapFile)));
							let c = { url: l.toString(), line: u.line, column: u.column, endLine: i && i.line, endColumn: i && i.column };
							if ("file:" === l.protocol) {
				...
				939: (e, t, s) => {
					...
					function y(e) {
						let t;
						return (
							(t = "document" === e.type ? ["Document", m, "DocumentExit"] : "root" === e.type ? ["Root", m, "RootExit"] : w(e)),
					...
					class v {
						constructor(e, t, s) {
							...
							if (
								...
								if (t instanceof v || t instanceof h)
									(r = x(t.root)),
										t.map && (void 0 === s.map && (s.map = {}), s.map.inline || (s.map.inline = !1), (s.map.prev = t.map));
								else {
									let e = u;
						...
						handleError(e, t) {
							...
							try {
								t && t.addToError(e),
									(this.error = e),
									"CssSyntaxError" !== e.name || e.plugin ? s.postcssVersion : ((e.plugin = s.postcssPlugin), e.setMessage());
							} catch (e) {
							...
							for (let t of this.plugins)
								if ("object" == typeof t)
									for (let s in t) {
										...
										if (!d[s])
											if ("object" == typeof t[s]) for (let r in t[s]) e(t, "*" === r ? s : s + "-" + r.toLowerCase(), t[s][r]);
						...
						visitTick(e) {
							...
							for (; t.eventIndex < n.length; ) {
								...
								if (((t.eventIndex += 1), e === m))
									return void (s.nodes && s.nodes.length && ((s[r] = !0), (t.iterator = s.getIterator())));
							...
							if (!1 !== this.mapOpts.annotation)
								if (this.root) {
									...
									for (let t = this.root.nodes.length - 1; t >= 0; t--)
										(e = this.root.nodes[t]),
											"comment" === e.type && 0 === e.text.indexOf("# sourceMappingURL=") && this.root.removeChild(t);
								...
								if (
									...
									l &&
										...
										l.source && l.source.start
											...
											: ((o.source = n), (o.original.line = 1), (o.original.column = 0), this.map.addMapping(o))),
									(e = i.match(/\n/g)),
									e ? ((s += e.length), (t = i.lastIndexOf("\n")), (r = i.length - t)) : (r += i.length),
									l && "start" !== a)
								) {
									let e = l.parent || { raws: {} };
					...
					class h {
						...
						error(e, t = {}) {
							if (this.source) {
								...
								return this.source.input.error(e, { line: s.line, column: s.column }, { line: r.line, column: r.column }, t);
							}
							return new n(e);
						}
						warn(e, t, s) {
						...
						replaceWith(...e) {
							if (this.parent) {
								let t = this,
									s = !1;
								for (let r of e)
									r === this ? (s = !0) : s ? (this.parent.insertAfter(t, r), (t = r)) : this.parent.insertBefore(t, r);
								s || this.remove();
							}
							return this;
						}
						...
						toJSON(e, t) {
							...
							for (let e in this) {
								...
								let r = this[e];
								if (Array.isArray(r)) s[e] = r.map((e) => ("object" == typeof e && e.toJSON ? e.toJSON(null, t) : e));
								else if ("object" == typeof r && r.toJSON) s[e] = r.toJSON(null, t);
								else if ("source" === e) {
									let n = t.get(r.input);
									null == n && ((n = i), t.set(r.input, i), i++), (s[e] = { inputId: n, start: r.start, end: r.end });
								} else s[e] = r;
							}
						...
						rangeBy(e) {
							...
							return (
								(s.line < t.line || (s.line === t.line && s.column <= t.column)) && (s = { line: t.line, column: t.column + 1 }),
								{ start: t, end: s }
							);
						}
						getProxyProcessor() {
							return {
								set: (e, t, s) => (
									e[t] === s ||
										((e[t] = s),
										("prop" !== t && "value" !== t && "name" !== t && "params" !== t && "important" !== t && "text" !== t) ||
											e.markDirty()),
									!0
								),
					...
					e.exports = class {
						...
						other(e) {
							let t = !1,
								...
								a = e;
							for (; a; ) {
								if (((s = a[0]), l.push(a), "(" === s || "[" === s)) i || (i = a), n.push("(" === s ? ")" : "]");
						...
						decl(e, t) {
							...
							for (
								...
								1 === e.length && this.unknownWord(e), (s.raws.before += e.shift()[1]);
				...
				20: (e, t, s) => {
					...
					(v.plugin = function (e, t) {
						...
						return (
							Object.defineProperty(i, "postcss", { get: () => (s || (s = i()), s) }),
				...
				723: (e, t, s) => {
					...
					class l {
						...
						normalize(e) {
							...
							for (let s of e)
								if (
									(!0 === s.postcss ? (s = s()) : s.postcss && (s = s.postcss), "object" == typeof s && Array.isArray(s.plugins))
								)
									t = t.concat(s.plugins);
								else if ("object" == typeof s && s.postcssPlugin) t.push(s);
								else if ("function" == typeof s) t.push(s);
								else if ("object" != typeof s || (!s.parse && !s.stringify)) throw new Error(s + " is not a PostCSS plugin");
							return t;
						}
					}
				...
				25: (e, t, s) => {
					...
					class o extends n {
						...
						removeChild(e, t) {
							let s = this.index(e);
							return (
								!t && 0 === s && this.nodes.length > 1 && (this.nodes[1].raws.before = this.nodes[s].raws.before),
								super.removeChild(e)
							);
						}
						normalize(e, t, s) {
							...
							if (t)
								if ("prepend" === s) this.nodes.length > 1 ? (t.raws.before = this.nodes[1].raws.before) : delete t.raws.before;
				...
				62: (e) => {
					...
					class s {
						...
						atrule(e, t) {
							...
							if ((void 0 !== e.raws.afterName ? (s += e.raws.afterName) : r && (s += " "), e.nodes)) this.block(e, s + r);
							else {
						...
						block(e, t) {
							...
							this.builder(t + r + "{", e, "start"),
								e.nodes && e.nodes.length ? (this.body(e), (s = this.raw(e, "after"))) : (s = this.raw(e, "after", "emptyBody")),
								s && this.builder(s),
								this.builder("}", e, "end");
						}
						raw(e, s, r) {
							...
							return (
								e.walkComments((e) => {
									if (void 0 !== e.raws.before)
										return (s = e.raws.before), s.includes("\n") && (s = s.replace(/[^\n]+$/, "")), !1;
								}),
								void 0 === s ? (s = this.raw(t, null, "beforeDecl")) : s && (s = s.replace(/\S/g, "")),
								s
							);
						}
						rawBeforeDecl(e, t) {
							...
							return (
								...
								void 0 === s ? (s = this.raw(t, null, "beforeRule")) : s && (s = s.replace(/\S/g, "")),
								s
							);
						}
						rawBeforeRule(e) {
							...
							return (
								e.walk((s) => {
									if (s.nodes && (s.parent !== e || e.first !== s) && void 0 !== s.raws.before)
								...
								switch (((S = F.charCodeAt(z)), S)) {
									...
									case p:
										if (
											((j = _.length ? _.pop()[1] : ""),
											(U = F.charCodeAt(z + 1)),
											"url" === j && U !== t && U !== s && U !== o && U !== n && U !== a && U !== l && U !== h)
										) {
											A = z;
											do {
											...
											(A = F.indexOf(")", z + 1)),
												(R = F.slice(z, A + 1)),
												-1 === A || C.test(R) ? (B = ["(", "(", z]) : ((B = ["brackets", R, z, A]), (z = A));
										break;
									case t:
									case s:
										(P = S === t ? "'" : '"'), (A = z);
									...
									case x:
										(b.lastIndex = z + 1),
											b.test(F),
											(A = 0 === b.lastIndex ? F.length - 1 : b.lastIndex - 2),
									...
									case r:
										...
										if (
											((S = F.charCodeAt(A + 1)),
											E && S !== i && S !== o && S !== n && S !== a && S !== h && S !== l && ((A += 1), O.test(F.charAt(A))))
										) {
									...
									default:
										S === i && F.charCodeAt(z + 1) === w
											...
											: ((v.lastIndex = z + 1),
											  v.test(F),
											  (A = 0 === v.lastIndex ? F.length - 1 : v.lastIndex - 2),
