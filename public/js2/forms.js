			...
			!(function (e) {
				...
				t.addType(n, {
					...
					t.addType(a, {
						...
						model: { defaults: { tagName: "textarea", attributes: {}, traits: [d, u, m] } },
					}),
					t.addType(l, {
						isComponent: function (e) {
							return "OPTION" == e.tagName;
						},
						model: { defaults: { tagName: "option", layerable: !1, droppable: !1, draggable: !1, highlightable: !1 } },
					}),
					t.addType(i, {
						extend: o,
						isComponent: function (e) {
					...
					t.addType(s, {
						...
						model: {
							defaults: {
								...
								traits: [{ name: "id" }, d, { name: "value" }, m, { type: "checkbox", name: "checked" }],
							},
						},
						view: {
							events: { click: v },
							...
							handleChecked: function () {
								var e;
								this.el.checked = !!(null === (e = this.model.get("attributes")) || void 0 === e ? void 0 : e.checked);
							},
						},
					}),
					t.addType(r, {
						...
						model: {
							defaults: {
								...
								traits: [
									...
									{ type: "select", name: "type", options: [{ value: "button" }, { value: "submit" }, { value: "reset" }] },
								],
							},
							init: function () {
					...
					e.TraitManager.addType("select-options", {
						...
						onValueChange: function () {
							for (var e = this.model, t = this.target, n = e.get("value").trim().split("\n"), o = [], a = 0; a < n.length; a++) {
								var i = n[a].split("::");
								o.push({ type: l, components: i[1] || i[0], attributes: { value: i[0] } });
							}
				...
				(function (e, t) {
					var l = t,
						...
						m = function (e, n) {
							var o;
							(null === (o = l.blocks) || void 0 === o ? void 0 : o.indexOf(e)) >= 0 &&
								u.add(e, d(d(d({}, n), { category: l.category, select: !0 }), t.block(e)));
						};
					m(n, {
						label: "Form",
						media:
						...
						content: {
							...
							components: [
								...
								{ components: [{ type: c, components: "Message" }, { type: a }] },
								{ components: [{ type: p }] },
							],
						},
					}),
