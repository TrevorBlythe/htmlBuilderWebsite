			...
			s &&
				...
				t.Components.addType(u, {
					isComponent: function (t) {
						var e;
						return null === (e = t.hasAttribute) || void 0 === e ? void 0 : e.call(t, h);
					},
					model: {
						defaults: n(
							{
								...
								traits: m([
									...
									{ name: y, label: "Visible", type: "checkbox", valueTrue: "true" },
									{
										name: "style-tooltip",
										...
										command: function (t) {
											...
											if ((o.set("stylable", p), t.StyleManager.select(o), d)) {
												var a = t.getSelected();
						...
						checkEmpty: function () {
							this[!this.components().length ? "addClass" : "removeClass"]("".concat(g));
						},
					},
				});
		};
