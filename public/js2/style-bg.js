...
!(function (e, t) {
	"object" == typeof exports && "object" == typeof module
		...
		? (exports["grapesjs-style-bg"] = t())
		: (e["grapesjs-style-bg"] = t());
															...
															var a = (function () {
																...
																p = (function (e) {
																	function t() {
																		...
																		var l = e.el;
																		if (!((l = "string" == typeof l ? document.querySelector(l) : l) instanceof HTMLElement))
																			throw "Element not found, given " + l;
																		return (
																			(n.el = l),
																			(n.handlers = []),
																			(n.options = e),
																		...
																		a(t, [
																			{
																				...
																				value: function () {
																					...
																					this.clear(),
																						(this.e = {}),
																						["el", "handlers", "options", "colorPicker"].forEach(function (t) {
																							return (e[t] = 0);
																						}),
																			...
																			},
																			{
																				...
																				value: function (e, t) {
																					...
																					return (
																						["linear", "repeating-linear"].indexOf(r) >= 0 &&
																							o.indexOf(i) >= 0 &&
																							(i = "center" === i ? "to right" : "to " + i),
																						["radial", "repeating-radial"].indexOf(r) >= 0 &&
																							o.indexOf(i) >= 0 &&
																							(i = "circle at " + i),
																						n ? r + "-gradient(" + i + ", " + n + ")" : ""
																					);
																			...
																			},
																			{
																				...
																				value: function (e, t) {
																					var n = this.previewEl,
																						r = this.getValue(e, t);
																					if ((!this.sandEl && (this.sandEl = document.createElement("div")), !n || !r))
																						return "";
																					for (
																						var o = this.sandEl.style,
																							i = [r].concat(
																								(function (e) {
																									if (Array.isArray(e)) {
																									...
																									return Array.from(e);
																								})(this.getPrefixedValues(e, t))
																							),
																							a = void 0,
																							l = 0;
																						l < i.length && ((a = i[l]), (o.backgroundImage = a), o.backgroundImage != a);
																						l++
																					);
																		...
																		o(e, [
																			...
																			},
																			{
																				...
																				value: function (e) {
																					...
																					(this.position = e),
																						n && (n.style.left = e + "%"),
																						this.emit("handler:position:change", this, t);
																				},
																			},
																			{
																				key: "getColor",
																			...
																			},
																			{
																				...
																				value: function () {
																					var e = this,
																						...
																						n = this.cpFn,
																						r = this.getEl(),
																						o = this.gp.getHandlers(),
																						a = o.splice(o.indexOf(this), 1)[0];
																					return (
																						r && r.parentNode.removeChild(r),
																						!t.silent && this.emit("handler:remove", a),
																						(0, i.isFunction)(n) && n(this),
																						["el", "gp"].forEach(function (t) {
																							return (e[t] = 0);
																						}),
																						a
																					);
																			...
																			},
																			{
																				...
																				value: function () {
																					var e = this,
																						...
																						d = t.querySelector("[data-toggle=handler-drag]"),
																						p = function (t) {
																					...
																					if (
																						(c &&
																							(0, i.on)(c, "click", function (e) {
																								return e.stopPropagation();
																							}),
																						l &&
																							(0, i.on)(l, "click", function (t) {
																								t.stopPropagation(), e.remove();
																							}),
																						s &&
																							((0, i.on)(s, "change", p),
																							(0, i.on)(s, "input", function (e) {
																								return p(e, 0);
																							})),
																						d)
																					) {
																						var f = 0,
																							...
																							b = function (t) {
																								...
																								(v = 1),
																									...
																									(f = 100 * m.x),
																									(f /= g.w),
																									(f = (f = (f = h + f) < o ? o : f) > a ? a : f),
																									e.setPosition(f, 0),
																									e.emit("handler:drag", e, f),
																									(0, i.isDef)(t.button) && 0 === t.which && k(t);
																							},
																							k = function t(n) {
																								(0, i.off)(document, "touchmove mousemove", b),
																									(0, i.off)(document, "touchend mouseup", t),
																									v && ((v = 0), e.setPosition(f), e.emit("handler:drag:end", e, f));
																							};
																						(0, i.on)(d, "touchstart mousedown", function (t) {
																							if (!(0, i.isDef)(t.button) || 0 === t.button) {
																								...
																								(h = e.position),
																									...
																									(y.x = r.clientX),
																									(y.y = r.clientY),
																									(0, i.on)(document, "touchmove mousemove", b),
																									(0, i.on)(document, "touchend mouseup", k),
								...
								return (
									(() => {
										...
										var e = n(9),
											...
											l = function (e, t, n) {
												var r = i(i([], u, !0), ["center"], !1),
													o = t;
												return (
													["linear", "repeating-linear"].indexOf(e) >= 0 &&
														r.indexOf(o) >= 0 &&
														(o = "center" === o ? "to right" : "to ".concat(o)),
													["radial", "repeating-radial"].indexOf(e) >= 0 && r.indexOf(o) >= 0 && (o = "circle at ".concat(o)),
													n ? "".concat(e, "-gradient(").concat(o, ", ").concat(n, ")") : ""
												);
											},
											c = function (e) {
											...
											d = '[data-toggle="handler-color-wrap"]',
										...
										const g = function (e, n) {
											void 0 === n && (n = {}),
												(function (e, n) {
													...
													y &&
														i.addType(y, {
															create: function (e) {
																...
																return (
																	...
																	"default" === v &&
																		...
																		l.on("handler:remove", m)),
																	v && l.setColorPicker(v),
																	a
																);
															},
															emit: function (e, t) {
															...
															update: function (e) {
																...
																if (r.getValue() !== t) {
																	var o = r.getHandlers();
																	o.map(m),
																		r.setValue(t, { silent: !0 }),
																		n.selectEdgeStops &&
																			[o[0], o[o.length - 1]].filter(Boolean).map(function (e) {
														...
														g &&
															i.addBuiltIn(g, {
																...
																properties: [
																	{ name: " ", full: !0, defaults: "none", type: y, property: p },
																	{
																		name: "Direction",
																		type: "select",
																		defaults: "right",
													...
													e,
													v({ grapickOpts: {}, selectEdgeStops: !0, styleType: "gradient", builtInType: "background-image" }, n)
												);
										};
									})(),
									r
			...
			(() => {
				...
				var a = function (e) {
					...
					l = function (n) {
						var r,
							o = (((r = {})[s] = e.Image), r);
						if (n.indexOf("url(") > -1) o[d] = n;
						else if (n.indexOf("gradient(") > -1) {
							var i = (0, t.parseGradient)(n),
								a = i.stops;
							if (2 === a.length && "linear" === i.type && a[0].color === a[1].color) (o[s] = e.Color), (o[p] = a[0].color);
							else {
								var l = (0, t.getValidDir)(i.direction) || t.GRAD_DIRS[0],
									c = i.type || t.GRAD_TYPES[0];
								(o[s] = e.Grad), (o[f] = (0, t.toGradient)(c, l, i.colors)), (o[v] = c), (o[h] = l);
							}
						}
						return o;
					},
					c = 'style="max-height: 16px; display: block; margin: 0 auto" viewBox="0 0 24 24"',
					u = "background-image",
					s = "__background-type",
					d = u,
					p = "".concat(d, "-color"),
				...
				const y = function (n, r) {
					...
					n.Styles.addBuiltIn("background", {
						...
						layerLabel: function (e, t) {
							var n,
								r = t.values,
								o = t.property.getProperty(s).getOption(r[s]);
						...
						fromStyle: function (e, t) {
							...
							return (
								e[u]
									? ((c = n.__splitStyleName(e, u, o).map(l)),
									  a.forEach(function (t) {
											var r = t.getId(),
												a = t.getName();
											a !== u &&
												n
													.__splitStyleName(e, a, o)
													.map(function (e) {
														var n;
						...
						properties: [
										...
										n
											...
											.forEach(function (t) {
												var n = t.getName(),
													o = !1;
												n !== s &&
													(((r === e.Image && [p, f, h, v].indexOf(n) < 0) ||
														(r === e.Color && n === p) ||
														(r === e.Grad && [f, h, v].indexOf(n) >= 0)) &&
														(o = !0),
													t.up({ visible: o }));
											});
								},
								options: [
									{
										...
										label: "<svg ".concat(
											c,
											'><path fill="currentColor" d="M8.5 13.5l2.5 3 3.5-4.5 4.5 6H5m16 1V5a2 2 0 00-2-2H5a2 2 0 00-2 2v14a2 2 0 002 2h14a2 2 0 002-2z"/></svg>'
										),
									},
									{
										id: e.Color,
										...
										label: "<svg ".concat(
											c,
											'><path fill="currentColor" d="M19 3H5a2 2 0 00-2 2v14a2 2 0 002 2h14a2 2 0 002-2V5a2 2 0 00-2-2z"/></svg>'
										),
									},
									{
										id: e.Grad,
										...
										label: "<svg ".concat(
											c,
											'><path fill="currentColor" d="M11 9h2v2h-2V9m-2 2h2v2H9v-2m4 0h2v2h-2v-2m2-2h2v2h-2V9M7 9h2v2H7V9m12-6H5a2 2 0 00-2 2v14a2 2 0 002 2h14a2 2 0 002-2V5a2 2 0 00-2-2M9 18H7v-2h2v2m4 0h-2v-2h2v2m4 0h-2v-2h2v2m2-7h-2v2h2v2h-2v-2h-2v2h-2v-2h-2v2H9v-2H7v2H5v-2h2v-2H5V5h14v6z"/></svg>'
										),
									},
								],
							},
							{ label: "Image", property: d, default: "none", functionName: "url", type: "file", full: !0 },
							{
							...
							{ property: "background-attachment", default: "scroll", type: "select", options: a(["scroll", "fixed", "local"]) },
							{ type: "select", default: "auto", property: "background-size", options: a(["auto", "cover", "contain"]) },
							...
							{ name: "Direction", property: h, type: "select", default: "right", options: a(t.GRAD_DIRS) },
							{ name: "Type", property: v, default: "linear", type: "select", options: a(t.GRAD_TYPES) },
						].map(function (e) {
							var t;
