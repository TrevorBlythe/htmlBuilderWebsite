		...
		const i = function (e, t) {
			...
			u
				? "string" == typeof u
					? s &&
					  ((d = !0),
					  (((a = u), ((c = document.createElement("script")).src = a), document.head.appendChild(c), c).onload = function () {
							i = window.CKEDITOR;
					  }))
					: u.inline && (i = u)
				: s && (i = window.CKEDITOR);
			...
			var g = function (e, t) {
				var n;
				(null === (n = null == t ? void 0 : t.focusManager) || void 0 === n ? void 0 : n.hasFocus) ||
				...
				n(
					{
								...
								return (
									u.extraPlugins
										? "string" == typeof u.extraPlugins
											...
											: Array.isArray(u.extraPlugins) && u.extraPlugins.push(s)
										: (u.extraPlugins = s),
									...
									a.on("instanceReady", function () {
										...
										t && ((t.style.display = "block"), l.onToolbar(t)), e.refresh(), f();
									}),
									a.on("dialogShow", function () {
										var e = document.querySelectorAll(".cke_dialog_background_cover, .cke_dialog_container");
										o(e, function (e) {
						...
						disable: function (e, t) {
							var n;
							(e.contentEditable = "false"), null === (n = null == t ? void 0 : t.focusManager) || void 0 === n || n.blur(!0);
						},
					},
					l.customRte
				)
